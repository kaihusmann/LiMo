...
\begin{equation}
\rho = \frac{}{} = \frac{cov(x_{i}, y_{i})}{\sqrt{\sigma_{x}^2 \sigma_{y}^2}} \Rightarrow \frac{16.52447} {34.29244} = 0.4818691 \;\;\;\;  \rho^2 = 0.2321979 = R^2
\end{equation}
...
### c)   
\begin{equation}
\hat{Var}(\hat{\beta}_{1}) = \frac{\sigma^2} {\sum \limits_{i=1}^n (x_{i}-\bar{x})^2}
\end{equation}

$\sigma^2$ über  $SS_{Error}$ berechnen  
\begin{equation}
\sigma^2 = \frac {\sum \limits_{i=1}^n (y_{i}-\bar{y})^2 - \sum \limits_{i=1}^n (\hat{y}_{i}-\bar{y})^2} {n - 2} \Rightarrow \frac{2950.57} {75} = 39.34093
\end{equation}
